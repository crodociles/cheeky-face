...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		for(i = 1; i < 12; i++){
			...
			$("#pic_row").append("<div class='gallery_thumb'><a href='assets/img/bump/"+ x + "'><img class='pic_thumb' src='assets/img/bump/" + x + "' alt='Baby bump pic'></a></div>");
